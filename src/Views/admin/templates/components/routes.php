...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function()
{
	...
	Route::get('/pages/{id}/translate/{locale}', ['as' => 'admin.pages.translate', 'uses' => 'Gaia\Pages\PageController@translate']);
    Route::post('/pages/{id}/translate/{locale}/store', ['as' => 'admin.pages.translate-store', 'uses' => 'Gaia\Pages\PageController@translateStore']);
});
